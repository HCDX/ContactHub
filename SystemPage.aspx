<%@ Page Title="" Language="C#" MasterPageFile="~/immain.Master" AutoEventWireup="true" CodeFile="SystemPage.aspx.cs" Inherits="SystemPage" %>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <span class="alert-header darker">Add/Update a Page</span>
                                        <div>
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="row">
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="input-group date">
                                                                    ...
                                                                    <asp:DropDownList runat="server" ID="ddlModule" class="form-control select2"
                                                                        ...
                                                                        data-placeholder="Select a Module"
                                                        ...
                                                        <div class="col-lg-12 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <asp:TextBox ID="txtPageName" runat="server" type="text"
                                                                        data-bv-message="This value is not valid"
                                                                        data-bv-notempty="true"
                                                         ...
                                                         <div class="col-lg-12 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                <label for="txtPageUrl">Page Label</label>
                                                                <div class="form-group">
                                                                    <asp:TextBox ID="txtPageUrl" runat="server" type="text"
                                                                        data-bv-message="This value is not valid"
                                                                        data-bv-notempty="true"
                                                                        data-bv-notempty-message="Mandatory field and can not be empty"
                                                                        data-bv-regexp="true"
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-sm-12 col-xs-12">
                                                            <div class="form-group ">
                                                                <label for="txtPageDescription">Description</label>
                                                                <asp:TextBox ID="txtPageDescription" runat="server" type="text"
                                                                    data-bv-message="This value is not valid"
                                                                    data-bv-notempty="true"
                                                                    data-bv-notempty-message="Mandatory field and can not be empty"
                                                                    data-bv-regexp="true"
