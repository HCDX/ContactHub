<%@ Page Language="C#" Title="Subscription" AutoEventWireup="true" CodeFile="Subscription.aspx.cs" Inherits="Subscription" %>
            ...
            <div class="page-container">
                ...
                <div class="page-header position-relative">
                    <div class="header-title">
                        <h1>ContactHub in Lebanon </h1>
                        <asp:LinkButton ID="BtnLogin" runat="server" ToolTip="Click to login" OnClick="BtnLogin_Click">Login</asp:LinkButton>
                    </div>
                ...
                <div class="page-body">
                    ...
                    <asp:UpdatePanel ID="UpdAdd" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                        <ContentTemplate>
                            ...
                            <div class="row">
                                <div class="container">
                                    <h1>Subscribe</h1>
                                    <h6>Please fill in this form to subscribe. By subscribing you agree to be <a href="#">member of our mailing list </a>and receive emails and notifications from our system.
                                    </h6>
                                    <br />

                                    <div class="alert alert-success fade in" id="subcription_success" runat="server" visible="false">
                                        <button class="close" title="Close the alert" data-dismiss="alert">
                                            ×
                                        </button>
                                        <i class="fa-fw fa fa-check"></i>
                                        <strong>
                                            <asp:Literal ID="subcription_success_msg" runat="server"></asp:Literal></strong>
                                    </div>

                                    <div class="alert alert-danger fade in" id="subscription_error" runat="server" visible="false">
                                        <button class="close" title="Close the alert" data-dismiss="alert">
                                            ×
                                        </button>
                                        <i class="fa-fw fa fa-times"></i>
                                        <strong>Error ! </strong>
                                        <asp:Literal ID="subscription_error_msg" runat="server"></asp:Literal>
                                    </div>
                                        ...
                                        <div class="col-lg-4 col-sm-12 col-xs-12">
                                            <div class="form-group ">
                                                <div class="autocomplete">
                                                    ...
                                                    <input runat="server" id="txtSubOrganization" type="text" name="myCountry" />
                                                </div>
                                            </div>
                                        </div>
                                        <%-- <div class="col-lg-4 col-sm-12 col-xs-12">
                                            <div class="form-group ">
                                                <label for="txtSubAddress"><b><i class="fa fa-map-marker" style="color: #3c8dbc"></i>&nbsp;Address</b></label>
                                                <asp:TextBox ID="txtSubAddress" runat="server" type="text"
                                                    data-bv-message="This value is not valid"
                                                    data-bv-notempty="true"
                                                    data-bv-notempty-message="This is a mandatory field and can not be empty"
                                                    data-bv-regexp="true"
                                    ...
                                    <div class="row" runat="server" visible="false" id="DivGrid">
                                        <div class="col-lg-12 col-sm-12 col-xs-12">
                                            <div class="widget">
                                                <div class="widget-header ">
                                                    <span class="widget-caption this-search-widget-caption">Choose your Sector(s) and Area(s) of Interest</span>
                                                </div>
                                                <asp:UpdatePanel ID="upSearch" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="BtnAddInterest" EventName="Click" />
                                                    </Triggers>
                                                    <ContentTemplate>
                                                                ...
                                                                <div class="row">
                                                                        ...
                                                                        <div class="form-group ">
                                                                            <div class="input-group date">
                                                                                <div class="input-group-addon">
                                                                                    <i class="fa fa-puzzle-piece" style="color: #3c8dbc"></i>
                                                                                </div>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group ">
                                                                            <div class="input-group date">
                                                                                <div class="input-group-addon">
                                                                                    <i class="fa fa-share-alt" style="color: #3c8dbc"></i>
                                                                                </div>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <asp:Button ID="BtnAddInterest" CssClass="btn btn-default" UseSubmitBehavior="false" runat="server" OnClick="BtnAddInterest_Click" Text="Add" />
                                                                    </div>
                                                                </div>
                                                                                        ...
                                                                                        <Columns>
                                                                                            <asp:TemplateField ItemStyle-HorizontalAlign="Left"
                                                                                                ...
                                                                                                <ItemTemplate>
                                                                                                    ...
                                                                                                    <asp:HiddenField ID="SubscriberID" runat="server" Value='<%# Bind("SubscriberID") %>' />
                                                                                        ...
                                                                                        <div class="modal-dialog">
                                                                                            <div class="modal-content">
                                                                                                ...
                                                                                                <div class="modal-body">
                                                                                                    ...
                                                                                                    <span class="alert-header darker">Add/Update a Interest</span>
                                                                                                    <div>
                                                                                                        <div class="row">
                                                                                                            <div class="col-sm-12">
                                                                                                                <div class="row">
                                                                                                                    ...
                                                                                                                    <div class="col-lg-12 col-sm-12 col-xs-12">
                                                                                                                        <div class="form-group ">
                                                                                                                            <label for="ddlSectorInterest1">Sector</label>
                                                                                                                            <div class="input-group date">
                                                                                                                                <div class="input-group-addon">
                                                                                                                                    <i class="fa fa-map-marker" style="color: #3c8dbc"></i>
                                                                                                                                </div>
                                                                                                                                <asp:DropDownList runat="server" ID="ddlSectorInterest1" class="form-control select2"
                                                                                                                                    data-allow-clear="true"
                                                                                                                                    data-placeholder="Select a Focal Point"
                                                                                                                                    data-bv-regexp="true">
                                                                                                                                </asp:DropDownList>
                                                                                                                    ...
                                                                                                                    <div class="col-lg-12 col-sm-12 col-xs-12">
                                                                                                                        <div class="form-group ">
                                                                                                                            <label for="ddlAreaInterest1">Area</label>
                                                                                                                            <div class="input-group date">
                                                                                                                                <div class="input-group-addon">
                                                                                                                                    <i class="fa fa-map-marker" style="color: #3c8dbc"></i>
                                                                                                                                </div>
                                                                                                                                <asp:DropDownList runat="server" ID="ddlAreaInterest1" class="form-control select2"
                                                                                                                                    data-allow-clear="true"
                                                                                                                                    data-placeholder="Select a Focal Point"
                                                                                                                                    data-bv-regexp="true">
                                                                                                                                </asp:DropDownList>
                    ...
                    <asp:Literal ID="execTimeLit" runat="server"></asp:Literal>
                                    ...
                                    <div class="form-group " style="float: right">
                                        <asp:Button ID="BtnSubscribe" CssClass="btn btn-info" ValidationGroup="authentication_box" OnClick="BtnSubscribe_Click" runat="server" Text="Subscribe" />
