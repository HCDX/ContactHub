<%@ Page Title="" Language="C#" MasterPageFile="~/immain.Master" AutoEventWireup="true" CodeFile="Areas.aspx.cs" Inherits="Areas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageHeaderTitlePlaceHolder" runat="server">
    <div class="header-title">
        <h1>Management of Area of Interest
        </h1>
    </div>
</asp:Content>
                ...
                <asp:UpdatePanel ID="upCrudGrid" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <div class="header bordered-blueberry this-search-widget-caption">
                            <div style="float: left">List of Area</div>
                            <div style="float: right">Total : <span style="color: red"><%=l%> </span>Area </div>
                        </div>
                        ...
                        <asp:GridView
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Left"
                                    ...
                                    <ItemTemplate>
                                        <asp:HiddenField ID="AreaInterestID" Value='<%# Bind("AreaInterestID") %>' runat="server" />
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="Left"
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="AreaInterestDescription" runat="server" Text='<%# Bind("AreaInterestDescription") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Left"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <span class="alert-header darker">Add/Update an Area of Interest</span>
                                        <div>
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                <label for="txtAreaInterestName">Area of Interest Name</label>
                                                                <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-sm-12 col-xs-12">
                                                            <div class="form-group ">
                                                                <label for="txtAreaInterestDescription">Description</label>
                                                                <asp:TextBox ID="txtAreaInterestDescription" runat="server" type="text"
                                                                    data-bv-message="This value is not valid"
                                                                    data-bv-notempty="true"
                                                                    data-bv-notempty-message="Mandatory field and can not be empty"
                                                                    data-bv-regexp="true"
